...
<p align="center">
  <i>Analista e Cientista de Dados | Estudante de Sistemas da Informação | Entusiasta em Inteligência Artificial</i>
</p>
...
Olá! Me chamo Gustavo Saraiva, tenho 21 anos e moro em Vila Velha - ES. Sou estudante de **Sistemas da Informação pelo IFES** e estou me aprofundando na área de dados, pela qual recentemente tenho me encantado bastante. Atualmente estou com o foco em análise e ciência de dados, utilizando ferramentas como **Python, SQL e Power BI, além de estar iniciando em R**.
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=html,css,javascript,php,react,nodejs,python,r,c,cs,cpp,java,kotlin,go,n8n,postgresql,mysql,sqlite,git,github,linux,windows,django,fastapi,vscode,visualstudio,pycharm" alt="Tech Stack"/>
  </a>
</p>
